...
public class ColorTracker {
    ...
    public ColorTracker(float nowR, float nowG, float nowB, float nowA) {
        this.nowR = nowR;
        this.nowG = nowG;
        this.nowB = nowB;
        this.nowA = nowA;
    ...
    public ColorTracker(Color input) {
    ...
    public ColorTracker(float toR, float toG, float toB, float toA, float time, Color input) {
        this.time = time;
        this.nowR = input.getRed();
        this.nowG = input.getGreen();
        this.nowB = input.getBlue();
