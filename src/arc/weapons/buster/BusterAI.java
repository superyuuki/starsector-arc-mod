...
public class BusterAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public BusterAI(MissileAPI missile, ShipAPI launchingShip) {
    ...
    public void advance(float amount) {
        ...
        if (target == null
            ...
            if (MISSILE.getVelocity().lengthSquared() > 200 * 200) {
                //slow down for targetting stage
        ...
        if(MISSILE.getElapsed()>DELAY && Math.abs(MathUtils.getShortestRotation(MISSILE.getFacing(), VectorUtils.getAngle(MISSILE.getLocation(), lead)))<1){
            ...
            engine.spawnProjectile(MISSILE.getSource(), MISSILE.getWeapon(), Index.BUSTER_WARHEAD, MISSILE.getLocation(), MISSILE.getFacing(), MISSILE.getVelocity());
